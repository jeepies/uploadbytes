...
import { FaFemale, FaGithub } from "react-icons/fa";
import { Link } from "@remix-run/react";

export const meta: MetaFunction = () => {
  return [
    { title: "UploadBytes" },
    { name: "description", content: "Just a better image hosting platform." },
  ];
};
      ...
      <div className="relative mx-auto container">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-x-8 w-full p-6 lg:p-12 border-x overflow-hidden">
            <div className="z-10 flex min-h-64 items-start justify-center flex-col">
              <AnimatedGradientText align="left">
                ...
                >
                  Introducing UploadBytes
                </span>
                <ChevronRight className="ml-1 size-3 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
              </AnimatedGradientText>
              <p className="text-[3.5rem] font-semibold text-left">
                UploadBytes<span className="text-primary">.</span>
              </p>

              <h2 className="mt-[.5rem] text-[1rem] leading-relaxed max-w-md text-left">
                Say goodbye to complicated image hosting. UploadBytes gives you
                a streamlined platform to store and share your files, with
        ...
        <section id="faq">
          <div className="relative mx-auto container">
            ...
            <div className="border-x border-t grid grid-cols-1 sm:grid-cols-3">
              <div className="flex flex-col items-center justify-center space-y-2 p-8 border-r">
                <h3 className="font-semibold text-lg">What is UploadBytes?</h3>
                <p className="text-sm text-muted-foreground text-center">
                  UploadBytes is a modern image hosting platform focused on
              ...
              <div className="flex flex-col items-center justify-center space-y-2 p-8 border-r">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Yes, UploadBytes offers a generous free tier with essential
                  features.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center space-y-2 p-8">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  We support most common image formats including PNG, JPEG, etc.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between p-4">
            <div className="text-sm text-muted-foreground">
              © 2024 UploadBytes. All rights reserved.
            </div>
            <div className="flex items-center space-x-4">
              <Link
                to="https://github.com/jeepies/uploadbytes"
